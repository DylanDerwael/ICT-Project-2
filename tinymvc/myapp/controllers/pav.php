...
class Pav_Controller extends TinyMVC_Controller
{
/**
 * Admin
 *
...
function index(){
        ...
        $this->view->assign("html",$begin.$uithtml.$datum.$wie.$woon.$contact.$aardVraag.$Client.$aanbod.$einde);
        ...
        //--- register data ---
            ...
            {     
                ...
                $data =array(
                  ...
                  $x = $this->db->createRecord('pav',$data);                   
