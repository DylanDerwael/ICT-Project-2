<?php
class Basis_Controller extends TinyMVC_Controller
{
 /**
 * Admin
 *
 ...
 */
    function index(){
        ...
        $uit        = $this->objUitvoerder->genHTML();
        $datum      = $this->objDatum->genHTML();
        $wie        = $this->objWie->genHTML();
        $contact    = $this->objContact->genHTML('basis');
        $afkomst    = $this->objAfkomst->genHTML();
        $aardVraag  = $this->objVraag->genHTML('basis');
        $kind       = $this->objKind->genHTML('basis');
        ...
        $this->view->assign("titel","Basisinformatie");
        $this->view->assign("html",$begin.$uit.$datum.$wie.$contact.$afkomst.$woon.$kind.$aardVraag.$aanbod.$einde);
           ...
           // register data
            if(isset($_POST['register'])){
                ...
                $data =array(
                    ...
                    (isset($_POST['afkomst']) ? ($_POST['afkomst'] == 'allochtoon' ? $_POST['afkomst_txt'] : 'nvt'):'nvt') ,                        
                    (isset($_POST['locatie']) ? $_POST['locatie'] : 'nvt'),
                 ...
                 $this->db->createRecord('basisinfo',$data);
