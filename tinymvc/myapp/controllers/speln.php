<?php
class Speln_Controller extends TinyMVC_Controller{
     /**
 * Admin
 *
        ...
        if (isset($_POST['back'])){header('Location:  /deOpvoedingswinkel/index.php/indexc'); }
             ...
             if(isset($_POST['register'])){
                ...
                $data =array(
                  ...
                  $x = $this->db->createRecord('spelnamiddag',$data);
