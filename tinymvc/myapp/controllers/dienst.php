<?php
class Dienst_Controller extends TinyMVC_Controller{
 /**
 * Admin
 *
 ...
 */
     function index(){
        ...
        $titel      = $this->objTitel->genHTML('dienstvoorstelling');
        $uitvoerder = $this->objUitvoerder->genHTML();
        $datum      = $this->objDatum->genHTML();
        $wie        = $this->objWie->genHTML2('dienst');
        ...
        $this->view->assign("footer",$footer);
              ...
              if(isset($_POST['register'])){
                ...
                $data =array(
                  ...
                  $x = $this->db->createRecord('dienstvoorstelling',$data);
